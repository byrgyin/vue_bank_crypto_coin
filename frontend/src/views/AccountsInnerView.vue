        ...
        <div class="accounts-inner__middle-wrap-form">
          ...
          <form class="accounts-inner__middle-form">
            <label class="accounts-inner__middle-form-label" for="account">
              ...
              <select class="accounts-inner__middle-form-input" id="account" required name="account">
                <option value="74213041477477406320783754">74213041477477406320783754</option>
              </select>
            </label>
            <label class="accounts-inner__middle-form-label" for="amount">
              <span>Сумма перевода</span>
              <input class="accounts-inner__middle-form-input" id="amount" type="number" placeholder="Placeholder" required name="amount">
            </label>
            <button class="accounts-inner__middle-form-inputsubmit" type="submit">Отправить</button>
          </form>
        </div>
      </div>
